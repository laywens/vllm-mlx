...
class TestStreamingPromotion:
    ...
    Uses full-text or large chunk sizes. The upstream streaming parser uses
    current_text/previous_text tag detection which has imprecision when tags
    span chunk boundaries at very small chunk sizes.
    """
